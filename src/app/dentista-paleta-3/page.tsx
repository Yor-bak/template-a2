...
// Paleta 3 — "Azul clínico": mismo diseño que /dentista, solo cambia la paleta de color
// (azul/marino sobre gris muy claro) mediante variables CSS heredadas, sin duplicar el layout.
const paletteVars = {
  "--color-ivory": "#f4f8fb",
  "--color-ink": "#15202c",
  "--color-meridian": "#2f6fb0",
...
export default function DentistaPaleta3() {
  return (
