...
import { getPaymentMethodLabel, getShortAddress, getShortHoursLabel, getDentistInitials } from "@/lib/clinicUtils";

export default function HomePage() {
  const profile = usePublicProfile();
  const config = {
    dentistName: profile.specialist.displayName,
    specialty: profile.specialist.specialty,
    professionalLicense: profile.specialist.professionalLicense,
    yearsExperience: profile.specialist.yearsExperience ?? 0,
    patientsServed: profile.specialist.patientsServed ?? 0,
    welcomeMessage: profile.specialist.biography ?? profile.specialist.shortDescription,
    phone: profile.business.phone,
    whatsapp: profile.business.whatsapp,
    acceptsEmergencies: profile.business.acceptsEmergencies ?? false,
    emergencyDescription: profile.business.emergencyDescription,
    emergencyWhatsapp: profile.business.emergencyWhatsapp,
    acceptedPayments: profile.paymentMethods,
    openingHours: profile.openingHours,
    neighborhood: profile.business.address.neighborhood,
    city: profile.business.address.city,
    address: profile.business.address.street,
  };
